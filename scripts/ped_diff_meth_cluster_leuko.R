...
# the pediatric cohort (LEUKO as reference). 
# ============================================================
source("../config.R")
...
colData(se)$Consensus_Cluster <- relevel(factor(colData(se)$Consensus_Cluster), "LEUKO")
...
saveRDS(res, file = file.path(DATA_DIR, "ped_dm_cluster_leuko.rds"))
