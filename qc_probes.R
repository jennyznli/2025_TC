...
#   Usage: Rscript qc_betas.R <betas_filename> <platform>
#   Example: Rscript qc_betas.R ped_betas_raw.rds EPICv2
# ============================================================
library(sesame)
library(dplyr)
...
cat("Processing betas file:", BETAS_FILENAME, "\n")
...
# LOADING DATA
cat("Loading manifest and beta data...\n")
...
# EPICv2 SPECIFIC PROCESSING
if (PLATFORM == "EPICv2") {
    cat("\n4. EPICv2 detected - performing betasCollapseToPfx...\n")
